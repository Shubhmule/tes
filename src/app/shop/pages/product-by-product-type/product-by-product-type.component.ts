...
@Component({
  selector: 'app-product-by-product-type',
  templateUrl: './product-by-product-type.component.html',
  styleUrl: './product-by-product-type.component.scss'
})
export class ProductByProductTypeComponent {
