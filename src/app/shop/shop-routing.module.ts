...
import { ProductByProductTypeComponent } from './pages/product-by-product-type/product-by-product-type.component';
import { ProductByCategoryComponent } from './pages/product-by-category/product-by-category.component';
import { ProductByBrandComponent } from './pages/product-by-brand/product-by-brand.component';
...
const routes: Routes = [
  ...
  {
    path:'productByProductType',
    component:ProductByProductTypeComponent,
    title:'Product By Product Type Page'
  },
  {
    path:'productByProductCategory',
    component:ProductByCategoryComponent,
    title:'Product By Product Category Page'
  },
  {
    path:'productByProductBrand',
    component:ProductByBrandComponent,
    title:'Product By Product Brand Page'
  },
  {
    path:'shop-list',
